...
use pikaxe::io::*;
use pikaxe::scene::{GroupObject, MatObject, Matrix, MeshObject, Milo, MiloObject, Object, ObjectDir, PackedObject, RndMesh, Tex, Trans, TransConstraint};
...
impl From<&pikaxe::texture::Bitmap> for ImageInfo {
    fn from(b: &pikaxe::texture::Bitmap) -> Self {
        Self {
